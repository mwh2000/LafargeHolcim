...
<head>
    ...
    <title>KCML / SLV | إضافة رخصة عزل طاقة</title>
...
<body class="bg-gray-50">
    ...
    <div class="dashboard-container min-h-screen bg-[#0b6f76] bg-opacity-[5%]">
        <?php renderSidebar('energy_insulation'); ?>

        <div class="flex-1 flex flex-col sm:ml-64 transition-all">
            <main class="flex-1 overflow-y-auto p-8 md:pl-12">
                <div class="max-w-4xl mx-auto">
                    <h1 class="text-2xl font-semibold text-gray-700 mb-6">إضافة رخصة عزل طاقة</h1>

                    <!-- Progress Bar -->
                    <div class="flex justify-between mb-8 border-b pb-2">
                        <div class="step-indicator active px-2 transition-all duration-300" data-step="1">المعلومات</div>
                        ...
                        <div class="step-indicator px-2 transition-all duration-300" data-step="4">الطاقم</div>
                        <div class="step-indicator px-2 transition-all duration-300" data-step="5">المسؤول</div>
                    </div>
                    ...
                    <form id="licenseForm" class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="step-content active" data-step="1">
                            <h2 class="text-xl font-medium mb-4 text-[#0b6f76]">المعلومات الأساسية</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">رقم المعدة</label>
                                    <input type="text" name="equipment_no" required class="w-full px-4 py-2 border rounded-md focus:ring-[#0b6f76]">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="license_expiry" required class="w-full px-4 py-2 border rounded-md focus:ring-[#0b6f76]">
                                </div>
                                <div>
                                    ...
                                    <select name="work_permit" required class="w-full px-4 py-2 border rounded-md focus:ring-[#0b6f76]">
                                        <option value="عزل مباشر">عزل مباشر</option>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            let staffSelect = new TomSelect('#staff_selection', { persist: false, create: false, placeholder: 'اختر المستخدمين...' });
            let managerSelect = new TomSelect('#manager_selection', { persist: false, create: false, placeholder: 'اختر المسؤول...' });
            ...
            function updateUI() {
                ...
                if (currentStep === 3) loadEquipments();
                if (currentStep === 4 || currentStep === 5) loadEligibleUsers();
            }
            ...
            form.addEventListener('submit', async (e) => {
                ...
                const data = {
                    ...
                    equipment_no: formData.get('equipment_no'),
