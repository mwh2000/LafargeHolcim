                    ...
                    <form id="hotWorkForm" class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="step-content" data-step="6">
                            ...
                            <div class="max-w-md mx-auto space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-green-700 mb-2 justify-self-start" dir="rtl">طلب موافقة Shift Leader لتنفيذ الرخصة (مساءً) بعد الرابعة عصراً</label>
