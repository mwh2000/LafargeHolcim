...
<body class="bg-gray-50">
    ...
    <!-- ✅ Layout -->
    <?php renderNavbar('Users', '/public/notifications.php'); ?>
    ...
    <script>
        ...
        async function fetchUsers() {
            ...
            if (status) {
                ...
                else if (status === "0") params.append("is_active", 0);
            }
            ...
            try {
                ...
                // تأكدنا أن السيرفر يرجّع users داخل data.data.users
        ...
        // ✅ تطبيق الفلاتر والبحث بشكل مباشر
        ...
        // ✅ دالة لتأخير البحث (حتى ما يرسل كل حرف)
