...
<head>
    ...
    <title>Add Equipment Section</title>
</head>
<body class="bg-gray-50">
    <!-- ✅ Layout -->
    <?php renderNavbar('Add Equipment Section'); ?>
    <div class="dashboard-container min-h-screen bg-[#0b6f76] bg-opacity-[5%] flex">
        ...
        <div class="flex-1 flex flex-col sm:ml-64 transition-all p-8">
            <div class="bg-white p-6 rounded-lg shadow max-w-lg w-full mb-6">
                <h2 class="text-xl font-semibold mb-4 text-gray-800">New Equipment Section</h2>
                ...
                <form id="addSectionForm" class="space-y-4">
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button type="submit" class="px-4 py-2 bg-[#0b6f76] text-white rounded-md hover:bg-opacity-90 transition">Save Section</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        const API_URL = "../../api/admin/equipment_sections.php?action=create";
            ...
            try {
                ...
                if (data.success) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Success',
                        text: 'Equipment section created successfully',
