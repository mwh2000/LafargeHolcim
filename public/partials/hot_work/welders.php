<?php
// List of qualified welders (اللحام).
// 'inspection_date' is the date (Y-m-d) of the welder's last inspection/certification.
// A welder is considered expired once 18 months have passed since that date;
// null means no inspection date is on record and the welder is always selectable.
return [
